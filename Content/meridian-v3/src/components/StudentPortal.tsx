...
¡Quedo a la espera de su respuesta! 🎓`;
                              ...
                              return (
                                <a
                                  ...
                                  className="w-full py-4 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-black rounded-xl transition-all flex items-center justify-center gap-2.5 shadow-[0_4px_20px_rgba(37,211,102,0.3)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.45)]"
                                >
                                  ...
                                  Solicitar este paquete por WhatsApp
                                </a>
                              );
                            })()}
                          </div>
