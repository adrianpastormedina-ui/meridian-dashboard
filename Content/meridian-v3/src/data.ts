...
export const DICTIONARY = {
  ES: {
    ...
    timeline_desc: 'El camino hacia las mejores universidades se planifica trimestre a trimestre. El orden y la rigurosidad previenen el estrés de último año.',
    timeline_tab_grade: 'Grado',
    timeline_check_1: 'Soporte uno-a-uno garantizado',
    timeline_check_2: 'Revisión por directores consultores',
    timeline_check_3: 'Material del aula y simulados',
    timeline_check_4: 'Alertas de plazos académicos',
    ...
    unis_top_choice: 'Top Choice',
    unis_no_results: 'No se encontraron universidades que coincidan con la búsqueda.',
    ...
    advisors_did_you_know: '¿Sabías qué?',
    advisors_did_you_know_desc: 'Todos nuestros mentores escribieron monografías calificadas con grado \'A\' o rindieron el examen SAT obteniendo puntajes en el percentil 99%.',
    advisors_rating: 'CALIFICACIÓN',
    advisors_book_desc_pre: 'Reserva una llamada exploratoria gratuita con ',
    advisors_book_desc_post: ' para planificar el año.',
    ...
    portal_buy_hours: 'Tienda de Paquetes',
    ...
    portal_history: 'Historial de Sesiones',
    portal_book_session: 'Agendar Sesión',
    portal_logout: 'Cerrar Sesión',
    portal_program: 'Programa',
    portal_all: 'Todas',
    portal_pending: 'Por Confirmar',
    portal_confirmed: 'Confirmadas',
    portal_completed: 'Completadas',
    portal_date_time: 'Fecha y Hora',
    portal_subject: 'Materia y Avance',
    portal_duration: 'Duración',
    portal_status: 'Estado',
    portal_agreements: 'Acuerdos / Observaciones',
    portal_book_title: 'Agendar Nueva Sesión',
    portal_book_subtitle: 'Coordina tu clase con la plana de mentores asignados.',
    portal_book_subject: 'Materia',
    portal_book_mentor: 'Asesor / Mentor',
    portal_book_date: 'Fecha',
    portal_book_time: 'Hora de Inicio',
    portal_book_duration: 'Duración',
    portal_book_btn: 'Agendar Clase Ahora'
  },
  EN: {
    nav_home: 'Home',
    nav_about: 'About Us',
    ...
    timeline_desc: 'The path to top universities is planned quarter by quarter. Order and rigor prevent senior year stress.',
    timeline_tab_grade: 'Grade',
    timeline_check_1: 'Guaranteed 1-on-1 support',
    timeline_check_2: 'Review by consulting directors',
    timeline_check_3: 'Classroom and simulation materials',
    timeline_check_4: 'Academic deadline alerts',
    ...
    unis_top_choice: 'Top Choice',
    unis_no_results: 'No universities found matching your search.',
    ...
    advisors_did_you_know: 'Did you know?',
    advisors_did_you_know_desc: 'All our mentors wrote \'A\' graded extended essays or took the SAT scoring in the 99th percentile.',
    advisors_rating: 'RATING',
    advisors_book_desc_pre: 'Book a free discovery call with ',
    advisors_book_desc_post: ' to plan the year.',
    ...
    portal_history: 'Session History',
    portal_book_session: 'Book Session',
    portal_logout: 'Log Out',
    portal_program: 'Program',
    portal_all: 'All',
    portal_pending: 'Pending',
    portal_confirmed: 'Confirmed',
    portal_completed: 'Completed',
    portal_date_time: 'Date & Time',
    portal_subject: 'Subject & Progress',
    portal_duration: 'Duration',
    portal_status: 'Status',
    portal_agreements: 'Agreements / Notes',
    portal_book_title: 'Book New Session',
    portal_book_subtitle: 'Coordinate your class with assigned mentors.',
    portal_book_subject: 'Subject',
    portal_book_mentor: 'Advisor / Mentor',
    portal_book_date: 'Date',
    portal_book_time: 'Start Time',
    portal_book_duration: 'Duration',
    portal_book_btn: 'Book Class Now'
  }
};
